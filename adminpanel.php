...
<body>
    ...
    <main>
        <div class="container">
            <div class="menu-grid">
                <a href="customer_hadle.php" class="menu-item">Customer Handling</a>
                <a href="staff_handle.php" class="menu-item">Staff Handling</a>
                <a href="itemhadling.php" class="menu-item">Item Handling</a>
